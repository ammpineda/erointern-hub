        ...
        @foreach ($latestAnnouncements as $announcement)
            @if ($count < 3)
                <div class="announcement">
                    <h3>{{ $announcement->title }} [<span
                            style="color: #2828DCFF;">{{ $announcement->created_at }}</span>]</h3>
...
<section id="daily-reports">
    ...
    <div style="text-align: center; padding: 5px; margin: 10px;">
        <a href="{{ route('ShowUserDars', ['id' => $userId]) }}"
           style="color:white; text-decoration:none;" class="manage-btn">VIEW DAILY REPORTS</a>&nbsp&nbsp
